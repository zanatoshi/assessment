...
const Link = ({href, activeClassName = 'active', className: classNameProps, innerRef, naked, ...other}: LinkProps) => {
...
export const LinkRouter = React.forwardRef<HTMLAnchorElement, LinkProps>((props, ref) => (
